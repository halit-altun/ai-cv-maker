...
export function getPrimaryNavItems(): DashboardSidebarLink[] {
  return [
    ...
    },
    {
      id: 'outreach-logs',
      label: 'Mail Logları',
      href: appRoutes.outreachLogs,
      icon: History,
      matchPath: '/outreach-logs',
      group: 'primary',
    },
    {
      id: 'mail-tracking',
      label: 'Mail Takip',
      href: appRoutes.mailTracking,
      icon: MarkEmailRead,
      matchPath: '/mail-tracking',
      group: 'primary',
    },
    {
      id: 'outreach-projects',
      label: 'Outreach Projeleri',
      href: appRoutes.outreachProjects,
      icon: FolderSpecial,
      matchPath: '/outreach-projects',
      group: 'primary',
    },
    {
      id: 'profile',
